...
// Paths are relative (no leading slash) so they resolve against the document URL
// in both dev (Vite serves public/ at root) and packaged Electron (file:// loads
// dist/index.html, with assets copied alongside).
export const MODEL_PATHS = {
  buildingGeneric: 'models/city/building_generic.glb',
  buildingGunstore: 'models/city/building_gunstore.glb',
  buildingChurch: 'models/city/Church.glb',
